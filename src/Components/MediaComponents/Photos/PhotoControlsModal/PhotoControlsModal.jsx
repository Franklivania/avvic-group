...
const PhotoControlsModal = ({ image, className, title, left, right, closeModal, currentSlide, totalSlides}) => {
    ...
    <div id='ph-ct-modal' className={className}>
        <div id="ph-modal-content">
            ...
            <div id="gallery-controls">
                <ToggleButton className={'gallery-btns gallery-ctrl-btns gallery-left'} disabled={currentSlide === 0} onClick={left}>
                    <i className='fa-solid fa-chevron-left fa-3x'></i>
                </ToggleButton>

                <ToggleButton className={'gallery-btns gallery-ctrl-btns gallery-right'} disabled={currentSlide === totalSlides - 1} onClick={right}>
